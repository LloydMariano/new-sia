...
<a href="javascript:Clickheretoprint()" style="font-size:20px";>Print</a> | <a href="home.php" style="font-size:20px";>Dashboard</a>
<?php
...
<div style="margin: 0 auto; padding: 20px; width: 700px; font-weight: normal;">
	...
	<div style="width: 459px; float: left;">
		<center><label>AMK Inventory Management System</label></center>
	<br>
	Street Address<br>
	Brgy<br>
	TIN:<br>
